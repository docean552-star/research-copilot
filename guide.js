...
function downloadTemplates() {
  ...
  t.push('2. Generate and run a SINGLE shell script that creates the entire project structure at once:');
  t.push('   - Root: ~/research-papers/ (or platform equivalent, ASCII-only path)');
  t.push('   - Shared: ~/research-papers/memory/, ~/research-papers/templates/');
  t.push('   - Project: ~/research-papers/{project-name}/');
  t.push('   - Subdirs: phases/, papers-pdf/, draft/');
  t.push('   - Empty files: search-log.txt, outline.txt');
  t.push('   Do NOT create files one by one. One script, one run.');
  t.push('3. Extract templates from this file into the project directory:');
  t.push('   - CLAUDE.md from section "claude-md.md"');
  t.push('   - phases/phase-0.md through phases/phase-9.md from section "phase-protocols.md" (split by "---")');
  t.push('   - tasker.yaml from section "tasker-templates.yaml" (use phase 0 block)');
  t.push('4. Show user what was created (short list, not a wall of text)');
  t.push('5. Tell user: "Открой гайд и перейди к секции Phase 0. Там есть промт — скопируй и отправь мне."');
  t.push('');
